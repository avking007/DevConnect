...
import { add_exp } from '../../actions/profile';
import { Link, withRouter } from 'react-router-dom';

const AddExperience = ({ add_exp, history }) => {
...
export default connect(null, { add_exp })(withRouter(AddExperience));
